...
Análisis de ventas semanales de 45 tiendas Walmart (2010–2012) aplicando CRISP-DM.
Proyecto final del Minor en Análisis y Gestión de Datos – Universidad Privada Boliviana.

---

## 📊 Descripción

Este proyecto analiza 6,435 registros semanales de 45 tiendas Walmart en Estados Unidos,
explorando patrones de ventas, el impacto de feriados, la influencia de variables
macroeconómicas y el desempeño por tienda. Se implementaron dos modelos principales:
segmentación K-Means y pronóstico ARIMA.
